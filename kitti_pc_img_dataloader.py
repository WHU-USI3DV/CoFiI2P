...
from kpconv.preprocess_data import precompute_point_cloud_stack_mode, precompute_point_cloud_cuda
import time
from network import point2node
...
class kitti_pc_img_dataset(data.Dataset):
    def __init__(self, root_path, mode, num_pc,
                 ...
                 P_Rx_amplitude=0, P_Ry_amplitude=2.0 * math.pi, P_Rz_amplitude=0,num_kpt=128,is_front=False):
